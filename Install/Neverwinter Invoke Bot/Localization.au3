...
Func LoadLocalizationDefaults()
    If GetValue("Language") = "Russian" Then
        ...
        SetDefault("VIPAccountRewardButtonTopLeftOffsetX", 20)
        SetDefault("VIPAccountRewardButtonTopLeftOffsetY", 1)
        SetDefault("VIPAccountRewardButtonBottomRightOffsetX", 57)
        SetDefault("VIPAccountRewardButtonBottomRightOffsetY", 10)
