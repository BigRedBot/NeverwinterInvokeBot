...
Func LoadLocalizationDefaults()
    If $Language = "Russian" Then
        ...
        SetDefault("VIPRewardButtonWidth", 65)
        SetDefault("VIPRewardButtonHeight", 24)
        SetDefault("VIPRewardButtonGap", 14)
        ...
        SetDefault("LeadershipProfessionTasks_Workers", "Train a Footman|Train a Guard|Hire a Mercenary|Emergency Hire")
        SetDefault("LeadershipProfessionTasks_NoOptionalAssets", "Hire your first Mercenary|Basic Training|Pick Up Package|Protect Grateful Merchant|Complete Advanced Training|Emergency Hire|Hire a Mercenary|Train an Adventurer|Train a Hero|Train a Guard|Train a Footman")
        SetDefault("LeadershipProfessionTasks_RequireIngredients", "Feed the Needy|Train an Adventurer|Train a Hero|Survey Terrain|Train a Guard|Follow Map to Treasure Cache|Give Refugees a Home|Chart Region|Collect Goods from Market|Collect Taxes|Train a Footman|Protect Diamond Shipment|Assemble Maps|Raid Enemy Treasury|Build Shelters|Deliver Metals|Resell Goods at Bazaar|Follow Map to Treasure Hoard|Put Enemy Keep Under Siege|Assault Enemy Stronghold|Follow Map to an Unknown Location|Recover Large Mineral Claim|Capture Bandit Leader|Kill a Young Dragon|Hunt down an escaped Experiment")
        SetDefault("LeadershipProfessionTasks_Level_Unknown", "Capture Bandit Leader|Escort a Wizard's Seneschal|Guard Clerics of Ilmater|Protect Magical Goods Market|Train for the Protector's Tourney|Guard Young Noble on Trip|Chart Region|Provide Security For Pilgrims|War Games Training|Patrol the Mines|Tactical Training|Martial Training|Raid Enemy Supply Depot|Explore Local Area|Guard Duty|Protect Caravan|Feed the Needy|Train a Footman|Train a Guard|Hire a Mercenary|Emergency Hire|Hire your first Mercenary|Basic Training|Pick Up Package|Protect Grateful Merchant|Complete Advanced Training")
        ...
        SetDefault("LeadershipProfessionTasks_Level_24", "Capture Bandit Leader|Escort a Wizard's Seneschal|Guard Clerics of Ilmater|Protect Magical Goods Market|Train a Footman|Train a Guard|Hire a Mercenary|Emergency Hire")
        SetDefault("LeadershipProfessionTasks_Level_25", "Capture Bandit Leader|Escort a Wizard's Seneschal|Guard Clerics of Ilmater|Protect Magical Goods Market|Train a Footman|Train a Guard|Hire a Mercenary|Emergency Hire")
    Else
        SetDefault("VerifyFilesWindowTitle", "Verify?")
        SetDefault("ConnectionProblemWindowTitle", "Connection problem")
        SetDefault("InvokeKey", "{CTRLDOWN}i{CTRLUP}")
...
Func LoadLocalizations($lang = "", $file = "", $iniwrite = 1)
    ...
    If Not IsString($l) Or $l = "" Then
        ...
        If @error <> 0 Then Exit
        If $l = "" Or $lang Or ( Not $LanguageSupport And $l <> "English" ) Then
