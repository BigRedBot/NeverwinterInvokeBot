...
Func LoadLocalizationDefaults()
    If GetValue("Language") = "Russian" Then
        ...
        SetDefault("VIPAccountRewardButtonLeftOffset", 20)
        SetDefault("VIPAccountRewardButtonTopOffset", 13)
        SetDefault("VIPAccountRewardButtonRightOffset", 74)
        SetDefault("VIPAccountRewardButtonBottomOffset", 26)
