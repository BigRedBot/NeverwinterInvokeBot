...
Global $Title = $Name
#include "Shared.au3"
If _Singleton("Neverwinter Invoke Bot: Screen Detection" & "Jp4g9QRntjYP", 1) = 0 Then Exit MsgBox($MB_ICONWARNING + $MB_TOPMOST, $Name, Localize("ScreenDetectionAlreadyRunning"))
