...
Global $Title = $Name
#include "Shared.au3"
If _Singleton($Name & "Jp4g9QRntjYP", 1) = 0 Then Exit MsgBox($MB_ICONWARNING, $Name, Localize("MailAlreadyRunning"))
...
Func Mail()
    ...
    While 1
        ...
        SplashOff()
        $SplashWindow = 0
        If MsgBox($MB_OKCANCEL, $Title, Localize("ClickOKToPullItemsFromMail")) <> $IDOK Then End()
