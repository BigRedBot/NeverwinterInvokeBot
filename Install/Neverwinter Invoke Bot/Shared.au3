...
Func LoadDefaults()
    ...
    SetDefault("LeadershipProfessionTasks_Level_Unknown", Localize("Capture_Bandit_Leader") & "|" & Localize("Escort_a_Wizards_Seneschal") & "|" & Localize("Guard_Clerics_of_Ilmater") & "|" & Localize("Protect_Magical_Goods_Market") & "|" & Localize("Train_for_the_Protectors_Tourney") & "|" & Localize("Guard_Young_Noble_on_Trip") & "|" & Localize("Chart_Region") & "|" & Localize("Provide_Security_For_Pilgrims") & "|" & Localize("War_Games_Training") & "|" & Localize("Patrol_the_Mines") & "|" & Localize("Tactical_Training") & "|" & Localize("Martial_Training") & "|" & Localize("Raid_Enemy_Supply_Depot") & "|" & Localize("Explore_Local_Area") & "|" & Localize("Guard_Duty") & "|" & Localize("Protect_Caravan") & "|" & Localize("Feed_the_Needy") & "|" & Localize("Train_a_Footman") & "|" & Localize("Train_a_Guard") & "|" & Localize("Hire_a_Mercenary") & "|" & Localize("Emergency_Hire") & "|" & Localize("Hire_your_first_Mercenary") & "|" & Localize("Basic_Training") & "|" & Localize("Pick_Up_Package") & "|" & Localize("Protect_Grateful_Merchant") & "|" & Localize("Complete_Advanced_Training"))
    SetDefault("LeadershipProfessionTasks_Level_0", Localize("Hire_your_first_Mercenary"))
    SetDefault("LeadershipProfessionTasks_Level_1", Localize("Feed_the_Needy") & "|" & Localize("Basic_Training") & "|" & Localize("Pick_Up_Package") & "|" & Localize("Protect_Grateful_Merchant") & "|" & Localize("Complete_Advanced_Training") & "|" & Localize("Emergency_Hire"))
    ...
    SetDefault("LeadershipProfessionTasks_Level_6", Localize("Martial_Training") & "|" & Localize("Explore_Local_Area") & "|" & Localize("Guard_Duty") & "|" & Localize("Hire_a_Mercenary") & "|" & Localize("Emergency_Hire"))
    ...
    SetDefault("LeadershipProfessionTasks_Level_8", Localize("Tactical_Training") & "|" & Localize("Martial_Training") & "|" & Localize("Raid_Enemy_Supply_Depot") & "|" & Localize("Train_a_Guard") & "|" & Localize("Hire_a_Mercenary") & "|" & Localize("Emergency_Hire"))
    SetDefault("LeadershipProfessionTasks_Level_9", Localize("Chart_Region") & "|" & Localize("Tactical_Training") & "|" & Localize("Martial_Training") & "|" & Localize("Raid_Enemy_Supply_Depot") & "|" & Localize("Train_a_Guard") & "|" & Localize("Hire_a_Mercenary") & "|" & Localize("Emergency_Hire"))
    SetDefault("LeadershipProfessionTasks_Level_10", Localize("Tactical_Training") & "|" & Localize("Martial_Training") & "|" & Localize("Raid_Enemy_Supply_Depot") & "|" & Localize("Train_a_Guard") & "|" & Localize("Hire_a_Mercenary") & "|" & Localize("Emergency_Hire"))
    SetDefault("LeadershipProfessionTasks_Level_11", Localize("Tactical_Training") & "|" & Localize("Martial_Training") & "|" & Localize("Raid_Enemy_Supply_Depot") & "|" & Localize("Train_a_Guard") & "|" & Localize("Hire_a_Mercenary") & "|" & Localize("Emergency_Hire"))
    SetDefault("LeadershipProfessionTasks_Level_12", Localize("Tactical_Training") & "|" & Localize("Martial_Training") & "|" & Localize("Raid_Enemy_Supply_Depot") & "|" & Localize("Train_a_Guard") & "|" & Localize("Hire_a_Mercenary") & "|" & Localize("Emergency_Hire"))
    SetDefault("LeadershipProfessionTasks_Level_13", Localize("War_Games_Training") & "|" & Localize("Patrol_the_Mines") & "|" & Localize("Tactical_Training") & "|" & Localize("Train_a_Footman") & "|" & Localize("Train_a_Guard") & "|" & Localize("Hire_a_Mercenary") & "|" & Localize("Emergency_Hire"))
    SetDefault("LeadershipProfessionTasks_Level_14", Localize("War_Games_Training") & "|" & Localize("Patrol_the_Mines") & "|" & Localize("Tactical_Training") & "|" & Localize("Train_a_Footman") & "|" & Localize("Train_a_Guard") & "|" & Localize("Hire_a_Mercenary") & "|" & Localize("Emergency_Hire"))
    SetDefault("LeadershipProfessionTasks_Level_15", Localize("War_Games_Training") & "|" & Localize("Patrol_the_Mines") & "|" & Localize("Tactical_Training") & "|" & Localize("Train_a_Footman") & "|" & Localize("Train_a_Guard") & "|" & Localize("Hire_a_Mercenary") & "|" & Localize("Emergency_Hire"))
    SetDefault("LeadershipProfessionTasks_Level_16", Localize("War_Games_Training") & "|" & Localize("Patrol_the_Mines") & "|" & Localize("Tactical_Training") & "|" & Localize("Train_a_Footman") & "|" & Localize("Train_a_Guard") & "|" & Localize("Hire_a_Mercenary") & "|" & Localize("Emergency_Hire"))
    SetDefault("LeadershipProfessionTasks_Level_17", Localize("War_Games_Training") & "|" & Localize("Patrol_the_Mines") & "|" & Localize("Tactical_Training") & "|" & Localize("Train_a_Footman") & "|" & Localize("Train_a_Guard") & "|" & Localize("Hire_a_Mercenary") & "|" & Localize("Emergency_Hire"))
    SetDefault("LeadershipProfessionTasks_Level_18", Localize("War_Games_Training") & "|" & Localize("Patrol_the_Mines") & "|" & Localize("Tactical_Training") & "|" & Localize("Train_a_Footman") & "|" & Localize("Train_a_Guard") & "|" & Localize("Hire_a_Mercenary") & "|" & Localize("Emergency_Hire"))
    SetDefault("LeadershipProfessionTasks_Level_19", Localize("War_Games_Training") & "|" & Localize("Patrol_the_Mines") & "|" & Localize("Tactical_Training") & "|" & Localize("Train_a_Footman") & "|" & Localize("Train_a_Guard") & "|" & Localize("Hire_a_Mercenary") & "|" & Localize("Emergency_Hire"))
    SetDefault("LeadershipProfessionTasks_Level_20", Localize("War_Games_Training") & "|" & Localize("Patrol_the_Mines") & "|" & Localize("Tactical_Training") & "|" & Localize("Train_a_Footman") & "|" & Localize("Train_a_Guard") & "|" & Localize("Hire_a_Mercenary") & "|" & Localize("Emergency_Hire"))
    SetDefault("LeadershipProfessionTasks_Level_21", Localize("Train_for_the_Protectors_Tourney") & "|" & Localize("War_Games_Training") & "|" & Localize("Patrol_the_Mines") & "|" & Localize("Train_a_Footman") & "|" & Localize("Train_a_Guard") & "|" & Localize("Hire_a_Mercenary") & "|" & Localize("Emergency_Hire"))
    SetDefault("LeadershipProfessionTasks_Level_22", Localize("Train_for_the_Protectors_Tourney") & "|" & Localize("Capture_Bandit_Leader") & "|" & Localize("Guard_Clerics_of_Ilmater") & "|" & Localize("War_Games_Training") & "|" & Localize("Train_a_Footman") & "|" & Localize("Train_a_Guard") & "|" & Localize("Hire_a_Mercenary") & "|" & Localize("Emergency_Hire"))
    SetDefault("LeadershipProfessionTasks_Level_23", Localize("Train_for_the_Protectors_Tourney") & "|" & Localize("Guard_Young_Noble_on_Trip") & "|" & Localize("Capture_Bandit_Leader") & "|" & Localize("Guard_Clerics_of_Ilmater") & "|" & Localize("Train_a_Footman") & "|" & Localize("Train_a_Guard") & "|" & Localize("Hire_a_Mercenary") & "|" & Localize("Emergency_Hire"))
    SetDefault("LeadershipProfessionTasks_Level_24", Localize("Capture_Bandit_Leader") & "|" & Localize("Escort_a_Wizards_Seneschal") & "|" & Localize("Guard_Clerics_of_Ilmater") & "|" & Localize("Protect_Magical_Goods_Market") & "|" & Localize("Train_a_Footman") & "|" & Localize("Train_a_Guard") & "|" & Localize("Hire_a_Mercenary") & "|" & Localize("Emergency_Hire"))
    SetDefault("LeadershipProfessionTasks_Level_25", Localize("Capture_Bandit_Leader") & "|" & Localize("Escort_a_Wizards_Seneschal") & "|" & Localize("Guard_Clerics_of_Ilmater") & "|" & Localize("Protect_Magical_Goods_Market") & "|" & Localize("Train_a_Footman") & "|" & Localize("Train_a_Guard") & "|" & Localize("Hire_a_Mercenary") & "|" & Localize("Emergency_Hire"))
EndFunc
