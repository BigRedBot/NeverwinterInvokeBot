...
Func LoadDefaults()
    ...
    SetDefault("BottomSelectedCharacterX", "378,    378,    378")
    SetDefault("BottomSelectedCharacterY", "346,    385,    385")
    SetDefault("BottomSelectedCharacterC", "CCFFFF, CCFFFF, CCFFFF")
    SetDefault("BottomScrollBarX", "436,    436,    436")
    SetDefault("BottomScrollBarY", "375,    414,    414")
    SetDefault("BottomScrollBarC", "44300C, 44300C, 261A07")
