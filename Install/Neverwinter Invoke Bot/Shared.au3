...
Func LoadDefaults()
    ...
    SetDefault("GameWidth", 1024)
    SetDefault("GameHeight", 768)
    SetDefault("ImageSearchTolerance", 50)
    SetDefault("InventoryBagSearchTolerance", 50)
    ...
    SetDefault("UsernameBoxX", 230)
    SetDefault("UsernameBoxY", 401)
    SetDefault("SelectCharacterMenuX", 290)
    SetDefault("SelectCharacterMenuY", 200)
    SetDefault("TopScrollBarX", 436)
    SetDefault("TopScrollBarY", 87)
    SetDefault("TopScrollBarC", "927B45")
    SetDefault("BottomScrollBarX", 436)
    SetDefault("BottomScrollBarY", 375)
    SetDefault("BottomScrollBarC", "44300C")
    SetDefault("TopSelectedCharacterX", 378)
    SetDefault("TopSelectedCharacterY", 132)
    SetDefault("TopSelectedCharacterC", "CCFFFF")
    SetDefault("BottomSelectedCharacterX", 378)
    SetDefault("BottomSelectedCharacterY", 346)
