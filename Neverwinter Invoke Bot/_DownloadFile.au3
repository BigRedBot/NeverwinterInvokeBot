...
Func _DownloadFile($DownloadURL, $DownloadTitle = "Downloading", $DownloadMsg = "Downloading: " & $DownloadURL)
    Local $DownloadFilePath = _WinAPI_GetTempFileName(@TempDir)
    ...
    If Number($DownloadSize) > 0 Then
        ...
        If @error Then
            ...
            Return 0
        EndIf
        GUICreate($DownloadTitle,420,84)
        ...
        EndIf
        InetClose($Download)
        If $Data[$INET_DOWNLOADCOMPLETE] And $Data[$INET_DOWNLOADSUCCESS] And Not $Data[$INET_DOWNLOADERROR] Then
